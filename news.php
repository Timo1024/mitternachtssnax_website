...
<body>
    ...
    <div style="padding-left: calc(100vw - 100%);">
        ...
        <div class="container">
            <header class="d-flex flex-wrap justify-content-center py-3 mb-4 border-bottom">
                ...
                <ul class="nav nav-pills">
                    ...
                    <li class="nav-item"><a href="#" class="nav-link active" aria-current="page">News</a></li>
        ...
        <h1 class="display-1" style="text-align: center;">News</h1>
        <p class="lead" style="text-align: center;">Hier bekommt ihr alle Neuigkeiten mit</p>

        <p style="margin: 1cm;"></p>

        <div class="album py-5 bg-light">
            <div class="container">
                <div id="show_news_inside_here" class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
                    ...
                    <?php 
                        ...
                        foreach($obj as $news_elem){
                            ...
                            echo '<button type="button" class="btn btn-sm btn-outline-secondary" onClick="document.location=\'#\'">nach oben</button>';
                            echo '</div>';
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="btn-group">
                                        <button type="button" class="btn btn-sm btn-outline-secondary">mehr
                                            infos</button>
                                        <button type="button" class="btn btn-sm btn-outline-secondary"
                                            onClick="document.location='#'">nach oben</button>
                                    </div>
                                    <small class="text-muted">13.12.21</small>
                                </div>
                            </div>
