...
<div id="body">
    ...
    <div style="padding-left: calc(100vw - 100%);">
            ...
            <header class="d-flex flex-wrap justify-content-center py-3 mb-4 border-bottom">
                ...
                <!-- <div class="d-flex align-items-center mb-3 mb-md-0 me-md-auto text-dark text-decoration-none">
                    ...
                    <a href="#" class="d-flex align-items-center mb-3 mb-md-0 me-md-auto text-dark text-decoration-none">
                        <img src="./assets/images/profilbild_02.png" alt="Snax Logo"
                            style="width:30px;border-radius: 5px;margin-right: 0.5cm;">
                        <span class="fs-4">Mitternachtssnax</span>
                    </a>
                </div>
                <div class="form-check form-switch d-flex align-items-center mb-3 mb-md-0 me-md-auto text-dark text-decoration-none">
                    <input class="form-check-input" type="checkbox" role="switch" id="flexSwitchCheckDefault">
                    <label class="form-check-label" for="flexSwitchCheckDefault">Dark Mode</label>
                  </div> -->
                    ...
                    <div class="modal-body p-5">
                        ...
                        <ul class="d-grid gap-4 my-5 list-unstyled">
                            <li class="d-flex gap-4">
                                <img src="./assets/images/ruben_2.jpg" alt="Robin"
                                    style="width:48px;height:48px;border-radius: 5px;margin-right: 0.2cm;margin-top: 0.2cm;">
                                <div>
                            ...
                            <li class="d-flex gap-4">
                                <img src="./assets/images/cici.jpg" alt="Cici"
                                    style="width:48px;height:48px;border-radius: 5px;margin-right: 0.2cm;margin-top: 0.2cm;">
                                <div>
                            ...
                            <li class="d-flex gap-4">
                                <img src="./assets/images/gizzi.jpg" alt="Gizzi"
                                    style="width:48px;height:48px;border-radius: 5px;margin-right: 0.2cm;margin-top: 0.2cm;">
                                <div>
                            ...
                            <li class="d-flex gap-4">
                                <img src="./assets/images/simoms.jpg" alt="Simon"
                                    style="width:48px;height:48px;border-radius: 5px;margin-right: 0.2cm;margin-top: 0.2cm;">
                                <div>
                            ...
                            <li class="d-flex gap-4">
                                <img src="./assets/images/jojo.jpg" alt="Jojo"
                                    style="width:48px;height:48px;border-radius: 5px;margin-right: 0.2cm;margin-top: 0.2cm;">
                                <div>
        ...
        <!-- Was machen wir -->
        <div class="modal fade" id="what_do_we_do" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
            aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content rounded-6 shadow">
                    <div class="modal-body p-5">
        ...
        <!-- Twitch -->
        <div class="modal fade" id="twitch_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
            aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content rounded-6 shadow">
                    <div class="modal-body p-5">
                        ...
                        <a class="btn btn-primary w-100" href="https://www.twitch.tv/mitternachtssnax" target="_blank"
                            id="a" onmouseover="chimage('./assets/images/external_link.png')"
                            onmouseout="chimage('./assets/images/external_link_white.png')">
                            <div class="container">
        ...
        <div class="modal fade" id="discord_bot" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
            aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content rounded-6 shadow">
                    <div class="modal-body p-5">
                        ...
                        <a class="btn btn-primary w-100" href="https://discord.gg/PBwPuYyFXR" target="_blank" id="c"
                            onmouseover="chimage2('./assets/images/external_link.png')"
                            onmouseout="chimage2('./assets/images/external_link_white.png')">
                            <div class="container">
                                <div class="row justify-content-md-center">
            ...
            <div class="row g-4 py-5 row-cols-1 row-cols-lg-2">
                <div class="col d-flex align-items-start">
                    ...
                    <div>
                        ...
                        <button type="button" class="btn btn-primary" id="team_icon_button" data-bs-toggle="modal"
                        ...
                        <div class="card shadow-sm">
                            <svg class="bd-placeholder-img card-img-top" width="100%" height="225"
                                ...
                                <defs>
                                    <pattern id="imgpattern" x="0" y="0" width="1" height="1"
                                             viewBox="0 0 2400 960" preserveAspectRatio="xMidYMid slice">
                                      <image width="2400" height="960" xlink:href="./assets/images/twitch_banner_02.png"/>
                                    </pattern>
                                </defs>

                                <title>Placeholder</title>
                                <rect width="100%" height="100%" fill="url(#imgpattern)" />
                                <rect x="10%" y="30%" rx="5" ry="5" width="80%" height="40%" style="fill:rgba(0, 0, 0, 0.425);" />
                                <text x="50%" y="50%" fill="#eceeef" dy=".3em">Discord Bot</text>
                            </svg>
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="btn-group">
                                        <button type="button" class="btn btn-sm btn-outline-secondary">mehr
                                            infos</button>
                                        <button type="button" class="btn btn-sm btn-outline-secondary"
                                            onClick="document.location='./news.php'">alle anzeigen</button>
                                    </div>
                                    <small class="text-muted">13.12.21</small>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card shadow-sm">
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <small class="text-muted">09.08.17</small>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col">
                        <div class="card shadow-sm">
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="btn-group">
                                        <button type="button" class="btn btn-sm btn-outline-secondary disabled">mehr
                                            infos</button>
                                        <button type="button" class="btn btn-sm btn-outline-secondary"
                                            onClick="document.location='./news.php'">alle anzeigen</button>
                                    </div>
                                    <small class="text-muted">28.01.15</small>
                                </div>
                            </div>
                        </div>
                    </div> -->
        ...
        <div class="container">
            <footer class="d-flex flex-wrap justify-content-between align-items-center py-3 my-4 border-top">
                ...
                <ul class="nav col-md-4 justify-content-end list-unstyled d-flex">
                    <li class="ms-3"><a class="text-muted" href="https://www.twitch.tv/mitternachtssnax"
                            target="_blank"><svg class="bi" width="24" height="24">
                                <use xlink:href="#twitch" />
                            </svg></a></li>
                    <li class="ms-3"><a class="text-muted" href="https://discord.gg/4nBdMhHJPU" target="_blank"><svg
                                class="bi" width="24" height="24">
                                <use xlink:href="#discord" />
                            </svg></a></li>
                    <li class="ms-3"><a class="text-muted" href="https://twitter.com/m_snaxx" target="_blank"><svg
                                class="bi" width="24" height="24">
                                <use xlink:href="#twitter" />
                            </svg></a></li>
                    <li class="ms-3"><a class="text-muted" href="https://www.instagram.com/mitternachtssnax/"
                            target="_blank"><svg class="bi" width="24" height="24">
                                <use xlink:href="#instagram" />
                            </svg></a></li>
                    <li class="ms-3"><a class="text-muted" href="https://www.tiktok.com/@mitternachtssnax"
                            target="_blank"><svg class="bi" width="24" height="24">
